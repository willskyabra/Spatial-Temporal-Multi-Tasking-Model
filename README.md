...
Developed as a Worcester Polytechnic Institute Major Qualifying Project (MQP).
...
The dataset is not included due to licensing and size restrictions.
Original data can be found here: https://www.andresmh.com/nyctaxitrips/
...
## Architecture
NYC Taxi Data > Feature Encoder > Transformer Encoder > Mask & Recovery > Pretrained Model (Trip Duration, Pickup Zone, Drop-off Zone)
